(function () {
  ...
  function showResults() {
    ...
    var imagen = document.getElementById("imglosewin");
  ...
  const myQuestions = [
    {
      ...
      answers: {
        a: "Solo por vos - Trueno",
        b: "Sauce - Dillom",
        c: "Sin mirar las señales - Rels B",
      },
      correctAnswer: "c",
    },
    {
      question: "¿Cuál es mi lenguaje de programacion favorito?",
      answers: {
        a: "python",
        b: "c",
        c: "java",
    ...
    {
      question: "que vacaciones prefiero?",
      answers: {
        a: "blufields con los negros",
        b: "Granada",
        c: "Leon",
        d: "Montelimar",
      },
